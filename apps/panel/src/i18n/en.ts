export default {
  ...
  providers: {
    ...
    oauthManualInfo_gemini: "Automatic sign-in failed (port 8085 is in use). Please complete sign-in manually: copy the authorization URL below, open it in your browser, sign in with Google, then paste the redirect URL back here.",
    "oauthManualInfo_openai-codex": "Automatic sign-in failed (port 1455 is in use). Please complete sign-in manually: copy the authorization URL below, open it in your browser, sign in with your ChatGPT account, then paste the redirect URL back here.",
  ...
  channels: {
    ...
    fieldGroupPolicyHint: "Controls how group/channel messages are handled",
    groupPolicyOpen: "Open - Respond in all groups the bot is added to",
    groupPolicyAllowlist: "Allowlist - Only respond in approved groups",
